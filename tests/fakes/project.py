...
class FakeProject:
    ...
    def __init__(
        ...
        *,
        ...
        # Arrangement markers as the controller sees them: (time, name). The time is
        # recorded because the fake project knows it, even though the controller's
        # arrangement reader cannot read it back: arrangement.getMarkerName is the
